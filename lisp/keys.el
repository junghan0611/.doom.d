...
(progn
  ...
  (defun my/open-now-file ()
    (interactive)
    (find-file (my/org-now-file)))
  ...
  (global-set-key (kbd "C-c j n") 'my/open-now-file)
  ...
  (global-set-key (kbd "C-c j o r") 'my/open-glossary-file)
  (global-set-key (kbd "C-c j o g") 'my/open-tags-file)
